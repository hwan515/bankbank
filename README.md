...
1학기 동안에 배운 내용을 다시 복습할 수 있는 프로젝트여서 의미가 깊었습니다. 
특히나, 모호했던 JWT 개념과 주식 데이터 분석을 통해 새로운 서비스를 생각하는 훈련을 할 수 있어서 더욱 좋았습니다. 
또한, 프로젝트를 문서화시키고 차근히 접근하여 팀원과 서로 합의된 내용하에 진행을 하니 이전보다 수월하게 진행할 수 있었습니다. 
본 프로젝트를 통하여, 협업의 중요성과 초기 설계 단계의 중요도를 몸소 깨달을 수 있었습니다.
