  ...
  <div class="page">
    <div class="container py-4">
      ...
      <template v-else-if="product">
        <!-- 상단 헤더 -->
        <div class="head">
          <div class="ui-badge">Deposit</div>
          <h1 class="ui-title serif-title">정기예금 상세</h1>
          <p class="ui-sub">
        ...
        <div class="layout">
          ...
          <div class="left">
            ...
            <router-link to="/products?tab=deposit" class="ui-btn ui-btn-ghost mt">
              ← 목록으로 돌아가기
            </router-link>
          </div>
      ...
      <div v-else class="state">
        ...
        <router-link to="/products?tab=deposit" class="ui-btn ui-btn-ghost mt">← 목록으로 돌아가기</router-link>
      </div>
